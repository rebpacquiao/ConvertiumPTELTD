      ...
      <div className="bg-white rounded-md p-1 flex items-center justify-between mt-8">
        <div className="w-full ">
          <div className="relative">
            <input
              className="w-full bg-transparent placeholder:text-slate-400 text-slate-700 rounded-md pl-3 pr-28 py-2 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300"
